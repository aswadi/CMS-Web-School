<div class="col-sm-3 col-md-2 sidebar">
  <ul class="nav nav-sidebar">
    ...
    <li class="active"><a href="../informasi/index.php">Informasi <span class="sr-only">(current)</span></a></li>
    <li class="dropdown">
  ...
  <ul class="nav nav-sidebar">
    ...
    <li class="dropdown">
      ...
      <ul class="dropdown-menu">
        ...
        while ($data = mysqli_fetch_assoc($result)) :
         ?>
        <li><a href="siswa.php?kelas=<?= $data['kelas']?>"><?= $data['kelas']?></a></li>
      <?php endwhile; ?>
        <li role="separator" class="divider"></li>
        <li><a href="siswa.php">Semua Siswa</a></li>
        <li role="separator" class="divider"></li>
      </ul>
    </li>
