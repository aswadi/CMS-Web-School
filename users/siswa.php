    ...
    <div class="container  konten">
      ...
      <div class="row">
        <div class="col-lg-4">
          ...
          ?>
          <img class="img-circle" src="../assets/img/home/<?= $multimedia['foto'];?>" alt="Generic placeholder image" width="140" height="140">
          <h2>Multimedia</h2><?= $multimedia['foto'];?>
          <?php
        ...
        <div class="col-lg-4">
          ...
          ?>
          <img class="img-circle" src="../assets/img/home/<?= $tsm['foto'];?>" alt="Generic placeholder image" width="140" height="140">
        ...
        <div class="col-lg-4">
          <?php $tampil_pertanian = tampil('jurusan', 'nama', 'Pertanian');
                $pertanian = mysqli_fetch_assoc($tampil_pertanian);
          ?>
          <img class="img-circle" src="../assets/img/home/<?= $pertanian['foto'];?>" alt="Generic placeholder image" width="140" height="140">
          <h2>Pertanian</h2>
          <?php
              // function tampil_2k($table, $field1, $k1, $field2, $k1)
              // "SELECT * FROM $table WHERE $field1 = '$k1' and $field2 = '$k2' ";
          ...
          <p><?= $data['nama']?> <br></p>
        <?php endwhile; ?>
          <p><a class="btn btn-default" href="siswa-perkelas.php?kelas=X Pertanian" role="button">View details &raquo;</a></p>
        </div><!-- /.col-lg-4 -->
      </div><!-- /.row -->
      <hr class="featurette-divider">
      <!-- kelas XI -->
      ...
      <div class="row">
        ...
        <div class="col-lg-4">
          ...
          <?php
              // function tampil_2k($table, $field1, $k1, $field2, $k1)
              // "SELECT * FROM $table WHERE $field1 = '$k1' and $field2 = '$k2' ";
              $result = tampil('siswa','kelas','XI Pertanian');
              while ($data = mysqli_fetch_assoc($result)) :
           ?>
          <p><?= $data['nama']?> <br></p>
        <?php endwhile; ?>
          <p><a class="btn btn-default" href="siswa-perkelas.php?kelas=XI Pertanian" role="button">View details &raquo;</a></p>
        </div><!-- /.col-lg-4 -->
      </div><!-- /.row -->
      <!-- kelas XII -->
      <h1>Kelas XII</h1>
      ...
      <div class="row">
        ...
        <div class="col-lg-4">
          <?php $tampil_pertanian = tampil('jurusan', 'nama', 'TPHP');
                $pertanian = mysqli_fetch_assoc($tampil_pertanian);
          ?>
          <img class="img-circle" src="../assets/img/home/<?= $pertanian['foto'];?>" alt="Generic placeholder image" width="140" height="140">
          <h2>Pertanian</h2>
          ...
          <p><?= $data['nama']?> <br></p>
        <?php endwhile; ?>
          <p><a class="btn btn-default" href="siswa-perkelas.php?kelas=XII Pertanian" role="button">View details &raquo;</a></p>
        </div><!-- /.col-lg-4 -->
      </div><!-- /.row -->
